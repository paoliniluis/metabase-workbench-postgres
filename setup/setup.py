...
postgres_ssh_3 = {"is_on_demand":False,"is_full_sync":True,"is_sample":False,"cache_ttl":None,"refingerprint":False,"auto_run_queries":True,"schedules":{},"details":{"host":"postgres-app-db","port":5432,"dbname":"metabase","user":"metabase","password":"mysecretpassword","schema-filters-type":"all","ssl":False,"tunnel-enabled":True,"tunnel-host":"ssh","tunnel-port":2222,"tunnel-user":"metabase","tunnel-auth-option":"ssh-key","tunnel-private-key":"-----BEGIN OPENSSH PRIVATE KEY-----\\n-----END OPENSSH PRIVATE KEY-----","tunnel-private-key-passphrase":"mysecretpassword","advanced-options":False},"name":"postgres-app-db-ssh","engine":"postgres"}
redshift_dev = {"is_on_demand":False,"is_full_sync":True,"is_sample":False,"cache_ttl":None,"refingerprint":False,"auto_run_queries":True,"schedules":{},"details":{"host":"redshift-dev.coibk2qefeg9.us-east-1.redshift.amazonaws.com","port":5439,"db":"sample","schema-filters-type":"all","user":"redshift_admin","password":"0UB8QFQiKHb1csJiaHf2KibG2XwkBtx1qaiFdQlA","tunnel-enabled":False,"advanced-options":False},"name":"rs","engine":"redshift"}

dbs = [pg_sample_15, app_db, postgres_big, postgres_ssh_1, postgres_ssh_2, postgres_ssh_3, redshift_dev]
